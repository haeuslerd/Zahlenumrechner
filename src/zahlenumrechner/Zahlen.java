...
public class Zahlen {
	static Scanner scanMenuEingabe = new Scanner(System.in); //Scanner welcher die Eingaben des Users Scannt und diese in die dafuer vorgesehene Variable zuweist
	...
	static int zahlenlaenge; // Zahlenlaenge der eingabe fuer Dual -> Dezimal da diese Variable von 2 Methoden verwendet wird
	static boolean nochmal = false; // fuer einen zusaetzlichen durchlauf 
	...
	public static void dezidu() {
		...
		int zwischensumme;
		int x;
		int dez= Integer.parseInt(menuZahl);
		String ergebnis = "";
			do {
				zwischensumme = dez/2;
				x=dez % 2;
		...
		System.out.println("Ergebnis: "+formatiereDualzahlen(ergebnis));
		menuZahl = ergebnis;	// damit Dezi zu Hex klappt ueber dual 		
	}
